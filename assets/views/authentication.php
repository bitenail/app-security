            ...
            <div class="row ">
                <div class="col-lg-12 sortable-layout">
                    ...
                    <div class="panel panel-primary plain">
                       ...
                       <div class="panel-body row col-xs-12">
                           <p class="text-info"> We are upgrading these three cloud modules, please wait until version 7 to use the cloud backup functions.</p>
                       </div>
                        <div class="panel-body row col-xs-12">
                            <div class="col-xs-2">
                                <?php
