...
<!--                                    <li><a data-toggle="tab" href="#admin-tools">Admin Tools</a></li>-->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="latest">
                                        <?php $this->model->getAnyFeed("https://www.centrora.com/category/blog/feed", $limit); ?>
                                    </div>
                                    <div class="tab-pane" id="changelog">
                                        <?php $this->model->getChangelogFeed("https://www.centrora.com/category/changelog/feed/atom/", $limit); ?>
                                    </div>
