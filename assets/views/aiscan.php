                            ...
                            <div id="aiscanner" class="tab-pane fade in active">
                                ...
                                <div class="row col-lg-12">
                                    ...
                                    <form id='new-aiscan-form' class="form-horizontal group-border stripped"
                                        ...
                                        <!--                                <input type="text" name="vssample" id="vssample">-->
                                    ...
                                    <!--                            <form id='aiscan-form' class="form-horizontal group-border stripped" role="form" enctype="multipart/form-data">-->
                                    <!--                                <input type="hidden" name="option" value="com_ose_firewall"> <input type="hidden" name="controller" value="aiscan"> <input type="hidden" name="action" value="aiscan">-->
                                    <!--                                <input type="hidden" name="task" value="aiscan">-->
                                    <!--                                <input type="file" name="vssample[]" id="vssample" multiple/>-->
                                    <!--                                <button type="submit" id="send-files">AI Analysis</button>-->
                                    <!--                            </form>-->
