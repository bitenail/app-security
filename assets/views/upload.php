                                        ...
                                        <div id="oseappcontainer">
                                            <div class="container">
                                                <div class="row" id="sub-header"
                                                     style="background:url('<?php echo "http://www.googledrive.com/host/0B4Hl9YHknTZ4X2sxNTEzNTBJUlE/sub_hd_bg.png" ?>') top center;  min-height:250px;">
                                                    <div id="unsub-left">
                                                    ...
                                                    <div class="col-md-6" id="unsub-right">
                                                        <a href="https://www.centrora.com/malware-removal"
                                                           id="leavetous" style="margin-top: 0px;">leave the work to us
                                                            now</a>
                                                    </div>
                                                </div>
                                                <div class="row">
