...
<div class="row">
    <div id="scan-result-panel" style="display: none;" data-bind="with:vl_data">
        <div class="col-md-12" data-bind="foreach: {data: $data, as: 'vls'}">
            <div>
                ...
                <div class="tab-content" >
                    <!-- CMS section -->
                    <div id="sectionWP" class="tab-pane fade in active" data-bind="with: vls.content.CMS.vulnerabilities">
                        <div>Your&nbsp<strong><?php echo OSE_CMS=='joomla'? 'Joomla' : 'Wordpress' ?></strong>&nbsp
                            <strong class="text-warning" data-bind="text:vls.content.CMS.version"></strong>&nbsphas vulnerabilities:&nbsp
                        </div>
                        <div id="scan-result-content" class="col-md-12" data-bind="foreach: $data">
                            <div id = "vl-short-desc" class="vl-short-desc collapsed">
                                <i class="fa fa-plus-circle"></i><strong data-bind="text:title" class="alert-danger"></strong>
                            </div>
                    ...
                    <div id="sectionPlu" class="tab-pane fade">
                        <div id="scan-result-content" class="col-md-12" data-bind="foreach: {data : vls.content.plugin, as:'plu'}">
                            <div id = "vl-short-desc" class="vl-short-desc collapsed">
                                ...
                                <strong class="text-warning" data-bind="text:plu.version"></strong>&nbspvulnerabilities
