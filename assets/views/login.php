									...
									<div class="form-group">
										<div class="col-sm-12">
											<div class="pull-right">
												<button type="submit" class="btn"><i id="ic-change" class="text-primary glyphicon glyphicon-log-in"></i> Sign in</button>
											</div>
										</div>
									</div>
							...
							<div class="col-md-5 white-bg login-form">
								...
								<form id = 'new-account-form' class="form-horizontal group-border stripped" role="form">
									...
									<div class="form-group">
										<div class="col-sm-12">
											<div class="pull-right">
												<button type="submit" class="btn" id='save-button'><i id="ic-change" class="text-primary glyphicon glyphicon-user"></i> <?php oLang::_('CREATE');?></button>
											</div>
										</div>
									</div>
								</form>
